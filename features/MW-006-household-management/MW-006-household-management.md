...
### No-Household Setup Screen — Mobile Light & Dark
![No-Household Setup Screen](./no-household-setup-mobile.png)

### Create Household — Mobile Light & Dark
![Create Household Mobile](./create-household-mobile.png)

### Join Household — Mobile Light & Dark
![Join Household Mobile](./join-household-mobile.png)

### No-Household Setup Screen — Desktop
![No-Household Setup Screen Desktop](./no-household-setup-desktop.png)

### Create Household — Desktop Modal
![Create Household Desktop](./create-household-desktop.png)

### Join Household — Desktop Modal
![Join Household Desktop](./join-household-desktop.png)

### Profile Dropdown — No Household
![Profile Dropdown No Household](./profile-dropdown-no-household.png)
