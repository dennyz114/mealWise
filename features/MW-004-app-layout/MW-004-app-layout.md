...
![Mobile Header + Tabs](./mobile-header-tabs.png)

### Mobile — Profile Menu
![Mobile Profile Menu](./mobile-profile-menu.png)

### Desktop — Collapsed Sidebar (Light)
![Desktop Collapsed Sidebar Light](./desktop-collapsed-light.png)

### Desktop — Collapsed Sidebar (Dark)
![Desktop Collapsed Sidebar Dark](./desktop-collapsed-dark.png)

### Desktop — Expanded Sidebar (Light)
![Desktop Expanded Sidebar Light](./desktop-expanded-light.png)

### Desktop — Expanded Sidebar (Dark)
![Desktop Expanded Sidebar Dark](./desktop-expanded-dark.png)

### Desktop — Profile Dropdown (Light)
![Desktop Profile Dropdown Light](./desktop-profile-light.png)

### Desktop — Profile Dropdown (Dark)
![Desktop Profile Dropdown Dark](./desktop-profile-dark.png)
